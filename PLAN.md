...
- [ ] M2: 摄入工作流 — 写清"加一篇源 → LLM 阅读 → 建/改词条 + 交叉链接 + 标矛盾"的可重复流程(含模板)
- [ ] M3: 种子词条 — 一批 LLM×OR 核心概念页(见下),建立交叉链接骨架
- [ ] M4: 导航与索引 — 完善 `maps/` 的 MOC/首页;可选接 MkDocs 做静态预览
- [ ] M5: 复利维护 — 健康检查:孤立页、断链、矛盾标注、摘要复审
